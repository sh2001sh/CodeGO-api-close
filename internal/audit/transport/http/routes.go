...
func RegisterAuditRoutes(apiRouter *gin.RouterGroup) {
	...
	logRoute.GET("/groups", middleware.AdminAuth(), GetAllLogGroups)
	logRoute.GET("/groups/options", middleware.AdminAuth(), GetAllLogGroupOptions)
	logRoute.GET("/stat", middleware.AdminAuth(), GetLogsStat)
	logRoute.GET("/self/stat", middleware.UserAuth(), GetLogsSelfStat)
	logRoute.GET("/self/groups", middleware.UserAuth(), GetUserLogGroups)
	logRoute.GET("/self/groups/options", middleware.UserAuth(), GetUserLogGroupOptions)
