...
var defaultTierSettings = []TierSetting{
	{Name: "1.00-1.50 统一额度", MinUSD: 1, MaxUSD: 1.5, Probability: 0.4366, RewardType: "claude_quota", WalletType: "claude"},
	...
	{Name: "2.80-4.00 统一额度", MinUSD: 2.8, MaxUSD: 4, Probability: 0.045, RewardType: "claude_quota", WalletType: "claude"},
	...
	{Name: "20.00-50.00 统一额度", MinUSD: 20, MaxUSD: 50, Probability: 0.002, RewardType: "claude_quota", WalletType: "claude"},
	{Name: "50.00-200.00 统一额度", MinUSD: 50, MaxUSD: 200, Probability: 0.0007, RewardType: "claude_quota", WalletType: "claude"},
	{Name: "200.00-1000.00 统一额度", MinUSD: 200, MaxUSD: 1000, Probability: 0.0002, RewardType: "claude_quota", WalletType: "claude"},
