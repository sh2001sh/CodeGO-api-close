...
var defaultBalanceBlindBoxTiers = []TierSetting{
	{Name: "$1.00-$3.00 普通额度", MinUSD: 1, MaxUSD: 3, Probability: 0.35, RewardType: "quota", WalletType: "default"},
	...
	{Name: "$15.00-$20.00 普通额度", MinUSD: 15, MaxUSD: 20, Probability: 0.18, RewardType: "quota", WalletType: "default"},
	{Name: "$25.00-$40.00 普通额度", MinUSD: 25, MaxUSD: 40, Probability: 0.04, RewardType: "quota", WalletType: "default"},
	{Name: "$80 普通额度", MinUSD: 80, MaxUSD: 80, Probability: 0.025, RewardType: "quota", WalletType: "default"},
	{Name: "$200 普通额度", MinUSD: 200, MaxUSD: 200, Probability: 0.006, RewardType: "quota", WalletType: "default"},
	{Name: "$500 普通额度", MinUSD: 500, MaxUSD: 500, Probability: 0.0015, RewardType: "quota", WalletType: "default"},
	{Name: "$1000 普通额度", MinUSD: 1000, MaxUSD: 1000, Probability: 0.001, RewardType: "quota", WalletType: "default"},
	...
	{Name: "充值九折卡", Probability: 0.0045, RewardType: "prop"},
	{Name: "套餐九折卡", Probability: 0.0025, RewardType: "prop"},
	{Name: "0.95 倍率卡", Probability: 0.0035, RewardType: "prop"},
	{Name: "0.9 倍率卡", Probability: 0.0021, RewardType: "prop"},
}
