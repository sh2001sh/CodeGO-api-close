...
func TestGetMigratesKnownLegacyUnifiedPool(t *testing.T) {
	...
	normalized := Get()
	require.InDelta(t, 0.52177312, normalized.BalanceBlindBoxTiers[0].Probability, 0.000000001)
	require.InDelta(t, 0.00000001, normalized.BalanceBlindBoxTiers[9].Probability, 0.000000001)
}
