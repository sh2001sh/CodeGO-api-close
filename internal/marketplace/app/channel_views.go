...
func channelViewWithLatestVerification(
	...
	view := &ChannelView{
		...
		PelicanProbeEnabled:       channel.PelicanProbeEnabled,
		PelicanProbeDailyMinute:   channel.PelicanProbeDailyMinute,
		PelicanProbeModel:         channel.PelicanProbeModel,
		PelicanProbeLastAt:        channel.PelicanProbeLastAt,
