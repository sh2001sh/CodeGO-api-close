...
const (
	...
	defaultGatewayExecutionRetentionDays = 30
	defaultRequestAuditRetentionDays     = 30
	defaultArchiveBatchSize              = 10000
...
func SettingsFromEnv() Settings {
	return Settings{
		...
		RequestAuditRetentionDays:     nonNegativeEnv("REQUEST_AUDIT_ARCHIVE_RETENTION_DAYS", defaultRequestAuditRetentionDays),
...
func (setting Settings) Enabled() bool {
	return setting.Directory != "" && (setting.LogRetentionDays > 0 || setting.GatewayExecutionRetentionDays > 0 || setting.RequestAuditRetentionDays > 0)
}
