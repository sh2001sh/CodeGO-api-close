...
func buildDefaultOptionMap() map[string]string {
	optionMap := map[string]string{
		...
		"NowPaymentsEnabled":                   strconv.FormatBool(commercestore.NowPaymentsEnabled),
		"NowPaymentsApiKey":                    commercestore.NowPaymentsApiKey,
		"NowPaymentsIPNSecret":                 commercestore.NowPaymentsIPNSecret,
		"NowPaymentsPaymentCurrency":           commercestore.NowPaymentsPaymentCurrency,
		"NowPaymentsPayCurrency":               commercestore.NowPaymentsPayCurrency,
		"NowPaymentsQuotaPerUSDT":              strconv.FormatFloat(commercestore.NowPaymentsQuotaPerUSDT, 'f', -1, 64),
		"NowPaymentsMinTopUp":                  strconv.Itoa(commercestore.NowPaymentsMinTopUp),
