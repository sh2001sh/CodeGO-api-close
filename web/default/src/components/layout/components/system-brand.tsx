  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'codego-inline-brand text-foreground inline-flex h-7 items-center gap-1.5 rounded-md px-1.5 text-sm font-medium transition-colors outline-none select-none',
