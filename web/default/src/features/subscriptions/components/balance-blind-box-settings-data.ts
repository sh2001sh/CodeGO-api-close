...
export const DEFAULT_BALANCE_BLIND_BOX_TIERS: BlindBoxTierSetting[] = [
  quotaTier('0.20-0.80 统一额度', 0.2, 0.8, 0.52177312),
  quotaTier('0.80-1.50 统一额度', 0.8, 1.5, 0),
  quotaTier('1.50-2.50 统一额度', 1.5, 2.5, 0.0107387),
  quotaTier('2.50-3.69 统一额度', 2.5, 3.69, 0.30367707),
  quotaTier('4.50-12.00 统一额度', 4.5, 12, 0.15),
  quotaTier('12.00-30.00 统一额度', 12, 30, 0.0001),
  quotaTier('30.00-100.00 统一额度', 30, 100, 0.00001),
  quotaTier('100.00-300.00 统一额度', 100, 300, 0.000001),
